        ...
        <div id="login-form" class="space-y-6">
            ...
            <form id="loginForm" class="space-y-4">
                <div>
                    ...
                    <input id="login-email" type="email" name="email" class="mt-1 w-full px-3 py-2 border rounded-md" required>
                </div>
                <div>
            ...
            <p class="text-center text-sm">Don't have an account? <a href="#" onclick="showRegister()" class="text-blue-500">Register</a></p>
        </div>
